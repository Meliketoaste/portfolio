...
;(function (C, g) {
  ...
  var C = function (g, q) {
        ...
        (function () {
          ...
          if (null === d.style.transform) {
            var c = ['Webkit', 'Moz', 'ms'],
              b
            for (b in c)
              if (void 0 !== d.style[c[b] + 'Transform'])
    ...
    q && q.breakpoints && P()
    g ||= '.rellax'
    g = 'string' === typeof g ? document.querySelectorAll(g) : [g]
    if (0 < g.length) {
      a.elems = g
      if (a.options.wrapper && !a.options.wrapper.nodeType)
        if ((g = document.querySelector(a.options.wrapper)))
          a.options.wrapper = g
        else {
          console.warn(
      ...
      var H,
        F = function () {
          for (var d = 0; d < e.length; d++)
            a.elems[d].style.cssText = e[d].style
          e = []
          ...
          for (d = 0; d < a.elems.length; d++) {
            var c = void 0,
              b = a.elems[d],
              f = b.getAttribute('data-rellax-percentage'),
              l = b.getAttribute('data-rellax-speed'),
              h = b.getAttribute('data-rellax-xs-speed'),
              w = b.getAttribute('data-rellax-mobile-speed'),
              x = b.getAttribute('data-rellax-tablet-speed'),
              y = b.getAttribute('data-rellax-desktop-speed'),
              z = b.getAttribute('data-rellax-vertical-speed'),
              A = b.getAttribute('data-rellax-horizontal-speed'),
              D = b.getAttribute('data-rellax-vertical-scroll-axis'),
              E = b.getAttribute('data-rellax-horizontal-scroll-axis'),
              S = b.getAttribute('data-rellax-zindex') || 0,
              T = b.getAttribute('data-rellax-min'),
              U = b.getAttribute('data-rellax-max'),
              V = b.getAttribute('data-rellax-min-x'),
              W = b.getAttribute('data-rellax-max-x'),
              X = b.getAttribute('data-rellax-min-y'),
              Y = b.getAttribute('data-rellax-max-y'),
              m = !0
            h || w || x || y ? (c = { xs: h, sm: w, md: x, lg: y }) : (m = !1)
            h = a.options.wrapper
            ...
            var B = a.options.vertical ? (f || a.options.center ? h : 0) : 0,
              M = a.options.horizontal
                ? f || a.options.center
                  ? a.options.wrapper
            ...
            b = b.style.cssText
            m = ''
            if ((f = /transform\s*:/i.exec(b)))
              (m = b.slice(f.index)),
                (m = (f = m.indexOf(';'))
                  ? ' ' + m.slice(11, f).replace(/\s/g, '')
                  : ' ' + m.slice(11).replace(/\s/g, ''))
            e.push({
              baseX: l.x,
              baseY: l.y,
              top: h,
        ...
        L = function () {
          ...
          return (d != p && a.options.vertical) ||
            (c != t && a.options.horizontal)
            ? !0
            : !1
        },
        ...
        n = function () {
          ...
          ;(a.options.wrapper
            ? a.options.wrapper
            : document
          ).removeEventListener('touchmove', n)
          v = J(I)
        },
        I = function () {
          L() && !1 === u
            ...
            : ((v = null),
              ...
              (a.options.wrapper
                ? a.options.wrapper
                : document
              ).addEventListener('touchmove', n, G ? { passive: !0 } : !1))
        },
        O = function () {
          for (var d, c = 0; c < a.elems.length; c++) {
            var b = e[c].verticalScrollAxis.toLowerCase(),
              f = e[c].horizontalScrollAxis.toLowerCase()
            d = -1 != b.indexOf('x') ? p : 0
            b = -1 != b.indexOf('y') ? p : 0
            var l = -1 != f.indexOf('x') ? t : 0
            f = -1 != f.indexOf('y') ? t : 0
            d = N(
              (d + l - e[c].left + k) / (e[c].width + k),
              (b + f - e[c].top + r) / (e[c].height + r),
              e[c].speed,
              e[c].verticalSpeed,
              e[c].horizontalSpeed,
            )
            ...
            null !== e[c].min &&
              (a.options.vertical &&
                ...
                (f = f <= e[c].min ? e[c].min : f),
              a.options.horizontal &&
                !a.options.vertical &&
                (b = b <= e[c].min ? e[c].min : b))
            null != e[c].minY && (f = f <= e[c].minY ? e[c].minY : f)
            null != e[c].minX && (b = b <= e[c].minX ? e[c].minX : b)
            null !== e[c].max &&
              (a.options.vertical &&
                !a.options.horizontal &&
                (f = f >= e[c].max ? e[c].max : f),
              a.options.horizontal &&
                !a.options.vertical &&
                (b = b >= e[c].max ? e[c].max : b))
